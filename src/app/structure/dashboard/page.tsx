...
export default function StructureDashboard() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Get active projects for structure engineer
      const activeRes = await fetch('/api/structure/active-projects')
      if (activeRes.ok) {
      ...
      const availableRes = await fetch('/api/structure/available-projects')
      if (availableRes.ok) {
  ...
  const handleAcceptProject = async () => {
    ...
    setIsAccepting(true)
    try {
      const response = await fetch('/api/structure/accept-project', {
        method: 'POST',
      ...
      <aside className="w-64 bg-[#121212] border-r border-gray-800 flex flex-col fixed h-full">
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-[#E67E22] via-[#F39C12] to-[#F1C40F] rounded-xl flex items-center justify-center">
              <Wrench className="w-6 h-6 text-white" />
            </div>
            <div>
              <h1 className="text-lg font-bold bg-gradient-to-r from-[#E67E22] via-[#F39C12] to-[#F1C40F] bg-clip-text text-transparent">
                ARCHI-COLL
              </h1>
              <p className="text-xs text-gray-500">Structure Portal</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-b border-gray-800">
          <div className="flex items-center gap-3">
            <Avatar className="w-12 h-12">
              ...
              <AvatarFallback className="bg-gradient-to-br from-[#E67E22] to-[#F39C12] text-white font-medium">
                {member?.user?.name?.charAt(0) || 'S'}
              </AvatarFallback>
            </Avatar>
            <div className="flex-1 min-w-0">
              <p className="text-white font-medium truncate">{member?.user?.name || 'Structure Engineer'}</p>
              <p className="text-xs text-gray-500 capitalize">{member?.profession || 'structure'}</p>
            </div>
          </div>
        </div>
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'dashboard' ? 'bg-[#E67E22]/20 text-[#F39C12]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'inbox' ? 'bg-[#E67E22]/20 text-[#F39C12]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'outbox' ? 'bg-[#E67E22]/20 text-[#F39C12]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'chat' ? 'bg-[#E67E22]/20 text-[#F39C12]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'video' ? 'bg-[#E67E22]/20 text-[#F39C12]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'portfolio' ? 'bg-[#E67E22]/20 text-[#F39C12]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'profile' ? 'bg-[#E67E22]/20 text-[#F39C12]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <div className="space-y-6">
            ...
            <div>
              <h2 className="text-3xl font-bold text-white mb-2">
                Selamat Datang, {member?.user?.name || "Structure Engineer"}!
              </h2>
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm mt-1">
                      Project struktur yang sedang Anda kerjakan
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-6">
                  {activeProjects.map((project) => (
                    <Card key={project.id} className="bg-gradient-to-br from-[#E67E22]/20 to-[#F39C12]/20 border-[#E67E22]/30">
                      <CardHeader>
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="flex flex-wrap gap-3">
                            <Button
                              ...
                              className="bg-gradient-to-r from-[#E67E22] to-[#F39C12] hover:from-[#E67E22]/80 hover:to-[#F39C12]/80"
                            >
                              <LayoutDashboard className="w-4 h-4 mr-2" />
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                {availableProjects.length > 0 && (
                  <Badge variant="outline" className="bg-[#E67E22]/20 text-[#F39C12] border-[#E67E22]/30">
              ...
              {availableProjects.length === 0 ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {availableProjects.map((project) => (
                    <Card key={project.id} className="bg-[#2a2a2a]/50 border-gray-800 hover:border-[#E67E22]/50 transition-colors">
                      <CardHeader>
                        <div className="flex items-start justify-between">
                          <div className="flex items-start gap-3">
                            <div className="w-12 h-12 bg-gradient-to-br from-[#E67E22]/20 to-[#F39C12]/20 rounded-xl flex items-center justify-center flex-shrink-0">
                              {getCategoryIcon(project.buildingCategory)}
                            </div>
                            <div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="pt-4 border-t border-gray-700">
                            <Button
                              ...
                              className="w-full bg-gradient-to-r from-[#E67E22] to-[#F39C12] hover:from-[#E67E22]/80 hover:to-[#F39C12]/80"
                            >
                    ...
                    {inboxMessages.map((msg: any) => (
                      <div
                        ...
                        className={`p-4 rounded-lg border ${
                          msg.isRead ? 'bg-gray-800/30 border-gray-700' : 'bg-[#E67E22]/10 border-[#E67E22]/30'
                        }`}
                      >
                        <div className="flex items-start justify-between mb-2">
                          ...
                          {!msg.isRead && (
                            <Badge className="bg-[#E67E22] text-white">Baru</Badge>
                          )}
                        </div>
              ...
              <CardContent>
                <div className="flex items-start gap-6">
                  <Avatar className="w-24 h-24">
                    <AvatarImage src={member.profileImage || ""} />
                    <AvatarFallback className="bg-gradient-to-br from-[#E67E22] to-[#F39C12] text-white text-2xl font-bold">
                      {member.user?.name?.charAt(0) || 'S'}
                    </AvatarFallback>
                  </Avatar>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                <Button
                  ...
                  className="flex-1 bg-gradient-to-r from-[#E67E22] to-[#F39C12] hover:from-[#E67E22]/80 hover:to-[#F39C12]/80"
                >
                  {isAccepting ? (
                    <>
