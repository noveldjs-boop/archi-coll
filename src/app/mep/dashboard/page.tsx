...
export default function MEPDashboard() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Get active projects for MEP engineer
      const activeRes = await fetch('/api/mep/active-projects')
      if (activeRes.ok) {
      ...
      const availableRes = await fetch('/api/mep/available-projects')
      if (availableRes.ok) {
  ...
  const handleAcceptProject = async () => {
    ...
    setIsAccepting(true)
    try {
      const response = await fetch('/api/mep/accept-project', {
        method: 'POST',
      ...
      <aside className="w-64 bg-[#121212] border-r border-gray-800 flex flex-col fixed h-full">
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-[#3498DB] via-[#2980B9] to-[#1ABC9C] rounded-xl flex items-center justify-center">
              <Zap className="w-6 h-6 text-white" />
            </div>
            <div>
              <h1 className="text-lg font-bold bg-gradient-to-r from-[#3498DB] via-[#2980B9] to-[#1ABC9C] bg-clip-text text-transparent">
                ARCHI-COLL
              </h1>
              <p className="text-xs text-gray-500">MEP Portal</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-b border-gray-800">
          <div className="flex items-center gap-3">
            <Avatar className="w-12 h-12">
              ...
              <AvatarFallback className="bg-gradient-to-br from-[#3498DB] to-[#2980B9] text-white font-medium">
                {member?.user?.name?.charAt(0) || 'M'}
              </AvatarFallback>
            </Avatar>
            <div className="flex-1 min-w-0">
              <p className="text-white font-medium truncate">{member?.user?.name || 'MEP Engineer'}</p>
              <p className="text-xs text-gray-500 capitalize">{member?.profession || 'mep'}</p>
            </div>
          </div>
        </div>
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'dashboard' ? 'bg-[#3498DB]/20 text-[#2980B9]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'inbox' ? 'bg-[#3498DB]/20 text-[#2980B9]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'outbox' ? 'bg-[#3498DB]/20 text-[#2980B9]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'chat' ? 'bg-[#3498DB]/20 text-[#2980B9]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'video' ? 'bg-[#3498DB]/20 text-[#2980B9]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'portfolio' ? 'bg-[#3498DB]/20 text-[#2980B9]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'profile' ? 'bg-[#3498DB]/20 text-[#2980B9]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <div className="space-y-6">
            ...
            <div>
              <h2 className="text-3xl font-bold text-white mb-2">
                Selamat Datang, {member?.user?.name || "MEP Engineer"}!
              </h2>
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm mt-1">
                      Project MEP yang sedang Anda kerjakan
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-6">
                  {activeProjects.map((project) => (
                    <Card key={project.id} className="bg-gradient-to-br from-[#3498DB]/20 to-[#2980B9]/20 border-[#3498DB]/30">
                      <CardHeader>
                        ...
                        <div className="space-y-6">
                          ...
                          <div className="flex flex-wrap gap-3">
                            <Button
                              ...
                              className="bg-gradient-to-r from-[#3498DB] to-[#2980B9] hover:from-[#3498DB]/80 hover:to-[#2980B9]/80"
                            >
                              <LayoutDashboard className="w-4 h-4 mr-2" />
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                {availableProjects.length > 0 && (
                  <Badge variant="outline" className="bg-[#3498DB]/20 text-[#2980B9] border-[#3498DB]/30">
              ...
              {availableProjects.length === 0 ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {availableProjects.map((project) => (
                    <Card key={project.id} className="bg-[#2a2a2a]/50 border-gray-800 hover:border-[#3498DB]/50 transition-colors">
                      <CardHeader>
                        <div className="flex items-start justify-between">
                          <div className="flex items-start gap-3">
                            <div className="w-12 h-12 bg-gradient-to-br from-[#3498DB]/20 to-[#2980B9]/20 rounded-xl flex items-center justify-center flex-shrink-0">
                              {getCategoryIcon(project.buildingCategory)}
                            </div>
                            <div>
                      ...
                      <CardContent>
                        <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="flex items-center gap-2">
                              <Building2 className="w-4 h-4 text-[#2980B9]" />
                              <div>
                          ...
                          <div className="pt-4 border-t border-gray-700">
                            <Button
                              ...
                              className="w-full bg-gradient-to-r from-[#3498DB] to-[#2980B9] hover:from-[#3498DB]/80 hover:to-[#2980B9]/80"
                            >
                    ...
                    {inboxMessages.map((msg: any) => (
                      <div
                        ...
                        className={`p-4 rounded-lg border ${
                          msg.isRead ? 'bg-gray-800/30 border-gray-700' : 'bg-[#3498DB]/10 border-[#3498DB]/30'
                        }`}
                      >
                        <div className="flex items-start justify-between mb-2">
                          ...
                          {!msg.isRead && (
                            <Badge className="bg-[#3498DB] text-white">Baru</Badge>
                          )}
                        </div>
              ...
              <CardContent>
                <div className="flex items-start gap-6">
                  <Avatar className="w-24 h-24">
                    <AvatarImage src={member.profileImage || ""} />
                    <AvatarFallback className="bg-gradient-to-br from-[#3498DB] to-[#2980B9] text-white text-2xl font-bold">
                      {member.user?.name?.charAt(0) || 'M'}
                    </AvatarFallback>
                  </Avatar>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                <Button
                  ...
                  className="flex-1 bg-gradient-to-r from-[#3498DB] to-[#2980B9] hover:from-[#3498DB]/80 hover:to-[#2980B9]/80"
                >
                  {isAccepting ? (
                    <>
