...
export default function QSDashboard() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Get active projects for QS
      const activeRes = await fetch('/api/qs/active-projects')
      if (activeRes.ok) {
      ...
      const availableRes = await fetch('/api/qs/available-projects')
      if (availableRes.ok) {
  ...
  const handleAcceptProject = async () => {
    ...
    setIsAccepting(true)
    try {
      const response = await fetch('/api/qs/accept-project', {
        method: 'POST',
      ...
      <aside className="w-64 bg-[#121212] border-r border-gray-800 flex flex-col fixed h-full">
        ...
        >
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-gradient-to-br from-[#9B59B6] via-[#8E44AD] to-[#1ABC9C] rounded-xl flex items-center justify-center">
              <Calculator className="w-6 h-6 text-white" />
            </div>
            <div>
              <h1 className="text-lg font-bold bg-gradient-to-r from-[#9B59B6] via-[#8E44AD] to-[#1ABC9C] bg-clip-text text-transparent">
                ARCHI-COLL
              </h1>
              <p className="text-xs text-gray-500">QS Portal</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-4 border-b border-gray-800">
          <div className="flex items-center gap-3">
            <Avatar className="w-12 h-12">
              ...
              <AvatarFallback className="bg-gradient-to-br from-[#9B59B6] to-[#8E44AD] text-white font-medium">
                {member?.user?.name?.charAt(0) || 'Q'}
              </AvatarFallback>
            </Avatar>
            <div className="flex-1 min-w-0">
              <p className="text-white font-medium truncate">{member?.user?.name || 'Quantity Surveyor'}</p>
              <p className="text-xs text-gray-500 capitalize">{member?.profession || 'qs'}</p>
            </div>
          </div>
        </div>
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'dashboard' ? 'bg-[#9B59B6]/20 text-[#8E44AD]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'inbox' ? 'bg-[#9B59B6]/20 text-[#8E44AD]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'outbox' ? 'bg-[#9B59B6]/20 text-[#8E44AD]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'chat' ? 'bg-[#9B59B6]/20 text-[#8E44AD]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'video' ? 'bg-[#9B59B6]/20 text-[#8E44AD]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'portfolio' ? 'bg-[#9B59B6]/20 text-[#8E44AD]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <Button
            ...
            className={`w-full justify-start ${
              activeNav === 'profile' ? 'bg-[#9B59B6]/20 text-[#8E44AD]' : 'text-gray-300 hover:bg-gray-800'
            }`}
          >
          ...
          <div className="space-y-6">
            ...
            <div>
              <h2 className="text-3xl font-bold text-white mb-2">
                Selamat Datang, {member?.user?.name || "Quantity Surveyor"}!
              </h2>
              <p className="text-gray-400">
                {activeProjects.length > 0
                  ? `Anda sedang mengerjakan ${activeProjects.length} project aktif. ${availableProjects.length > 0 ? `${availableProjects.length} undangan project lain tersedia.` : ''}`
              ...
              <div>
                <div className="flex items-center justify-between mb-6">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm mt-1">
                      Project kuantitas yang sedang Anda kerjakan
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-6">
                  {activeProjects.map((project) => (
                    <Card key={project.id} className="bg-gradient-to-br from-[#9B59B6]/20 to-[#8E44AD]/20 border-[#9B59B6]/30">
                      <CardHeader>
                      ...
                      <CardContent>
                        <div className="space-y-6">
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                              <p className="text-sm text-gray-400">RAB (Estimasi)</p>
                              <p className="text-white font-semibold">{formatCurrency(project.rab)}</p>
                            </div>
                            <div>
                              <p className="text-sm text-gray-400">Quality Level</p>
                              <p className="text-white capitalize">{project.qualityLevel || '-'}</p>
                            </div>
                          </div>
                          ...
                          <div className="flex flex-wrap gap-3">
                            <Button
                              ...
                              className="bg-gradient-to-r from-[#9B59B6] to-[#8E44AD] hover:from-[#9B59B6]/80 hover:to-[#8E44AD]/80"
                            >
                              <LayoutDashboard className="w-4 h-4 mr-2" />
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-gray-400 text-sm mt-1">
                    Undangan dari Arsitek untuk bergabung dalam project
                  </p>
                </div>
                {availableProjects.length > 0 && (
                  <Badge variant="outline" className="bg-[#9B59B6]/20 text-[#8E44AD] border-[#9B59B6]/30">
              ...
              {availableProjects.length === 0 ? (
                <Card className="bg-[#2a2a2a]/50 border-gray-800">
                  <CardContent className="py-12 text-center">
                    ...
                    <p className="text-gray-400">
                      Saat ini tidak ada undangan project baru. Undangan akan muncul setelah arsitek mengundang Anda.
                    </p>
                  </CardContent>
                </Card>
              ) : (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {availableProjects.map((project) => (
                    <Card key={project.id} className="bg-[#2a2a2a]/50 border-gray-800 hover:border-[#9B59B6]/50 transition-colors">
                      <CardHeader>
                        <div className="flex items-start justify-between">
                          <div className="flex items-start gap-3">
                            <div className="w-12 h-12 bg-gradient-to-br from-[#9B59B6]/20 to-[#8E44AD]/20 rounded-xl flex items-center justify-center flex-shrink-0">
                              {getCategoryIcon(project.buildingCategory)}
                            </div>
                            <div>
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="grid grid-cols-2 gap-4">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                <p className="text-xs text-gray-500">RAB</p>
                                <p className="text-sm text-white font-medium">{formatCurrency(project.rab)}</p>
                              </div>
                            </div>
                            <div className="flex items-center gap-2">
                          ...
                          <div className="pt-4 border-t border-gray-700">
                            <Button
                              ...
                              className="w-full bg-gradient-to-r from-[#9B59B6] to-[#8E44AD] hover:from-[#9B59B6]/80 hover:to-[#8E44AD]/80"
                            >
                    ...
                    {inboxMessages.map((msg: any) => (
                      <div
                        ...
                        className={`p-4 rounded-lg border ${
                          msg.isRead ? 'bg-gray-800/30 border-gray-700' : 'bg-[#9B59B6]/10 border-[#9B59B6]/30'
                        }`}
                      >
                        <div className="flex items-start justify-between mb-2">
                          ...
                          {!msg.isRead && (
                            <Badge className="bg-[#9B59B6] text-white">Baru</Badge>
                          )}
                        </div>
              ...
              <CardContent>
                <div className="flex items-start gap-6">
                  <Avatar className="w-24 h-24">
                    <AvatarImage src={member.profileImage || ""} />
                    <AvatarFallback className="bg-gradient-to-br from-[#9B59B6] to-[#8E44AD] text-white text-2xl font-bold">
                      {member.user?.name?.charAt(0) || 'Q'}
                    </AvatarFallback>
                  </Avatar>
          ...
          {selectedAvailableProject && (
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <p className="text-sm text-gray-400">RAB (Estimasi)</p>
                  <p className="text-white font-medium">{formatCurrency(selectedAvailableProject.rab)}</p>
                </div>
              </div>
              ...
              <div className="flex gap-3 pt-4">
                <Button
                  ...
                  className="flex-1 bg-gradient-to-r from-[#9B59B6] to-[#8E44AD] hover:from-[#9B59B6]/80 hover:to-[#8E44AD]/80"
                >
                  {isAccepting ? (
                    <>
